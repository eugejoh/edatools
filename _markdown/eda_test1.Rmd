...
if (any(grepl("01_load_packages.R",list.files(here::here())))) source(here("01_load_packages.R"))
...
foundation.packages <- c("haven","readr","here", #import
                         "dplyr","tidyr","purrr","data.table","janitor","magrittr","stringr", #process
                         "ggplot2","scales","forcats","ggfortify","grid","gridExtra", #data viz
                         "plotly","htmlwidgets","dygraphs","leaflet") #html widgets
